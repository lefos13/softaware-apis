...
export function buildOpenApiSpec() {
  return {
    ...
    paths: {
        ...
        get: {
          ...
          responses: {
            200: {
              ...
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/AccessPlanCatalogSuccessResponse' },
                },
              },
            },
            500: {
      ...
      '/api/access/token-requests': {
        post: {
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/TokenRequestCreateRequest' },
              },
            },
          },
          responses: {
            201: {
              ...
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/TokenRequestMutationSuccessResponse' },
                },
              },
            },
            400: {
              description: 'Invalid alias, email, or servicePolicies payload',
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/ErrorResponse' },
                },
      ...
      '/api/admin/token-requests': {
        get: {
          tags: ['Admin'],
          summary: 'List token requests',
          description:
            'Returns pending or historical token requests so the superadmin can review approvals and rejections from the admin tokens screen.',
          operationId: 'listTokenRequests',
          parameters: [
            {
              name: 'x-admin-token',
              in: 'header',
          ...
          responses: {
            200: {
              description: 'Token requests fetched successfully',
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/TokenRequestListSuccessResponse' },
                },
              },
            },
            401: {
      ...
      '/api/admin/token-requests/{requestId}/approve': {
        post: {
          ...
          description:
            'Creates the requested access token, emails it to the request owner, and marks the request approved. If email delivery fails, the created token is revoked and the request remains pending.',
          operationId: 'approveTokenRequest',
          parameters: [
            {
              name: 'x-admin-token',
              in: 'header',
            ...
            },
            {
              ...
              required: true,
              schema: { type: 'string' },
              description: 'Token request id to approve.',
            },
          ],
          requestBody: {
            required: false,
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/TokenRequestApproveRequest' },
              },
            },
          },
          responses: {
            200: {
              ...
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/TokenRequestApprovalSuccessResponse' },
                },
              },
            },
            400: {
              description: 'Invalid TTL payload',
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/ErrorResponse' },
                },
            ...
            409: {
              description: 'Token request already reviewed',
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/ErrorResponse' },
                },
            ...
            502: {
              description: 'Email delivery failed and the created token was revoked',
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/ErrorResponse' },
                },
      ...
      '/api/admin/token-requests/{requestId}/reject': {
        post: {
          tags: ['Admin'],
          summary: 'Reject a token request',
          description:
            'Emails the rejection decision to the request owner and marks the request rejected. If email delivery fails, the request remains pending.',
          operationId: 'rejectTokenRequest',
          parameters: [
            {
              name: 'x-admin-token',
              in: 'header',
            ...
            },
            {
              ...
              required: true,
              schema: { type: 'string' },
              description: 'Token request id to reject.',
            },
          ],
          requestBody: {
            required: false,
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/TokenRequestRejectRequest' },
              },
            },
          },
          responses: {
            200: {
              description: 'Token request rejected successfully',
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/TokenRequestMutationSuccessResponse' },
                },
      ...
      '/api/admin/tokens/{tokenId}/history': {
        get: {
          tags: ['Admin'],
          summary: 'List access token activity history',
          description:
            'Returns paginated usage history for one access token so superadmins can review the same activity log the owner dashboard exposes for the token holder.',
          operationId: 'listAccessTokenHistory',
          parameters: [
            {
              name: 'x-admin-token',
              in: 'header',
            ...
            },
            {
              ...
              required: true,
              schema: { type: 'string' },
              description: 'Access token id whose activity should be listed.',
            },
            {
              name: 'page',
              in: 'query',
              required: false,
              schema: { type: 'integer', minimum: 1, default: 1 },
              description: '1-based history page number.',
            },
            {
              name: 'limit',
              in: 'query',
              required: false,
              schema: { type: 'integer', minimum: 1, maximum: 100, default: 20 },
              description: 'History rows returned per page.',
            },
            {
              name: 'serviceKey',
              in: 'query',
          ...
          responses: {
            200: {
              description: 'Access token history fetched successfully',
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/AccessHistorySuccessResponse' },
                },
              },
            },
            401: {
      ...
      schemas: {
        ...
        AccessPlanCatalogService: {
          ...
          properties: {
            ...
            preset: { nullable: true, type: 'string', example: 'free_default' },
            kind: { nullable: true, type: 'string', example: 'composite' },
            requestsPerDay: { nullable: true, type: 'integer', minimum: 0, example: 1 },
            wordsTotal: { nullable: true, type: 'integer', minimum: 0, example: 10000 },
            presets: {
              type: 'array',
              items: { $ref: '#/components/schemas/AccessCatalogPolicy' },
            },
          },
          required: ['serviceKey'],
        },
        AccessPlanCatalogPayload: {
          type: 'object',
          properties: {
            freePlan: {
              type: 'object',
              properties: {
                planType: { type: 'string', enum: ['free'], example: 'free' },
                services: {
                  type: 'array',
        ...
        AccessPlanCatalogSuccessResponse: {
          ...
          properties: {
            success: { type: 'boolean', example: true },
            message: { type: 'string', example: 'Access plan catalog fetched successfully' },
            data: { $ref: '#/components/schemas/AccessPlanCatalogPayload' },
            meta: { $ref: '#/components/schemas/ResponseMeta' },
          },
          required: ['success', 'message', 'data', 'meta'],
        },
        AccessHistorySuccessResponse: {
          type: 'object',
          properties: {
            success: { type: 'boolean', example: true },
            message: { type: 'string', example: 'Access token history fetched successfully' },
            data: { $ref: '#/components/schemas/AccessHistoryPayload' },
            meta: { $ref: '#/components/schemas/ResponseMeta' },
          },
          required: ['success', 'message', 'data', 'meta'],
        },
        ...
        TokenRequestPayload: {
          type: 'object',
          properties: {
            requestId: { type: 'string', example: '45055d43-cc7b-4927-8a67-c1cb9c29cdea' },
            ...
            reviewedAt: { nullable: true, type: 'string', format: 'date-time' },
            reviewedByTokenId: { nullable: true, type: 'string' },
            resolvedTokenId: { nullable: true, type: 'string' },
            rejectionReason: { nullable: true, type: 'string' },
            lastEmailError: { nullable: true, type: 'string' },
            lastEmailAttemptAt: { nullable: true, type: 'string', format: 'date-time' },
          },
          required: [
            'requestId',
            'alias',
        ...
        TokenRequestCreateRequest: {
          ...
          required: ['alias', 'email', 'servicePolicies'],
        },
        TokenRequestApproveRequest: {
          type: 'object',
          properties: {
            ttl: { type: 'string', example: '30d' },
          },
        },
        TokenRequestRejectRequest: {
          type: 'object',
          properties: {
            reason: { type: 'string', example: 'Requested limits are not available right now.' },
          },
        },
        TokenRequestListPayload: {
          type: 'object',
          properties: {
            count: { type: 'integer', minimum: 0, example: 3 },
            pendingCount: { type: 'integer', minimum: 0, example: 2 },
            requests: {
              type: 'array',
              items: { $ref: '#/components/schemas/TokenRequestPayload' },
            },
          },
          required: ['count', 'pendingCount', 'requests'],
        },
        TokenRequestMutationPayload: {
          type: 'object',
          properties: {
            request: { $ref: '#/components/schemas/TokenRequestPayload' },
          },
          required: ['request'],
        },
        TokenRequestApprovalPayload: {
          type: 'object',
          properties: {
            request: { $ref: '#/components/schemas/TokenRequestPayload' },
            token: { $ref: '#/components/schemas/AccessTokenInventoryItem' },
          },
          required: ['request', 'token'],
        },
        TokenRequestListSuccessResponse: {
          type: 'object',
          properties: {
            success: { type: 'boolean', example: true },
            message: { type: 'string', example: 'Token requests fetched successfully' },
            data: { $ref: '#/components/schemas/TokenRequestListPayload' },
            meta: { $ref: '#/components/schemas/ResponseMeta' },
          },
          required: ['success', 'message', 'data', 'meta'],
        },
        TokenRequestMutationSuccessResponse: {
          type: 'object',
          properties: {
            success: { type: 'boolean', example: true },
            message: { type: 'string', example: 'Token request submitted successfully' },
            data: { $ref: '#/components/schemas/TokenRequestMutationPayload' },
            meta: { $ref: '#/components/schemas/ResponseMeta' },
          },
          required: ['success', 'message', 'data', 'meta'],
        },
        TokenRequestApprovalSuccessResponse: {
          type: 'object',
          properties: {
            success: { type: 'boolean', example: true },
            message: { type: 'string', example: 'Token request approved successfully' },
            data: { $ref: '#/components/schemas/TokenRequestApprovalPayload' },
            meta: { $ref: '#/components/schemas/ResponseMeta' },
          },
          required: ['success', 'message', 'data', 'meta'],
        },
